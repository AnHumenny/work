...
class Win(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.btn_list_claster = Label(self.menu, text="Кластеры")
        self.btn_list_claster.grid(row=8, column=0, padx=20)
        self.btn_list_mkn16 = ttk.Button(self.menu, text="mkn16", width=18, command=self.select_mkn_16)
        self.btn_list_mkn16.grid(row=9, column=0, padx=20)
        self.btn_list_mkn17 = ttk.Button(self.menu, text="mkn17", width=18, command=self.select_mkn_17)
        self.btn_list_mkn17.grid(row=10, column=0, padx=20)
        self.btn_list_mkn19 = ttk.Button(self.menu, text="mkn19", width=18, command=self.select_mkn_19)
        self.btn_list_mkn19.grid(row=11, column=0, padx=20)
        self.btn_list_mkn19 = ttk.Button(self.menu, text="Аэродром", width=18, command=self.select_aerodrom)
        self.btn_list_mkn19.grid(row=12, column=0, padx=20)
        self.btn_list_street = Label(self.menu, text="Улицы")
        self.btn_list_street.grid(row=13, column=0, padx=20)
        self.btn_list_mkn16 = ttk.Button(self.menu, text="Головацкого", width=18, command=self.select_golovackogo)
        self.btn_list_mkn16.grid(row=14, column=0, padx=20)
        self.btn_list_mkn17 = ttk.Button(self.menu, text="Мазурова", width=18, command=self.select_mazurova)
        self.btn_list_mkn17.grid(row=15, column=0, padx=20)
        self.btn_list_mkn19 = ttk.Button(self.menu, text="Кожара", width=18, command=self.select_kozhara)
        self.btn_list_mkn19.grid(row=16, column=0, padx=20)
        self.btn_list_mkn19 = ttk.Button(self.menu, text="Хатаевича", width=18, command=self.select_hataevicha)
        self.btn_list_mkn19.grid(row=17, column=0, padx=20)
        self.btn_list_street_bor = ttk.Button(self.menu, text="Бородина", width=18, command=self.select_borodina)
        self.btn_list_street_bor.grid(row=18, column=0, padx=20)
        self.btn_list_mkn16 = ttk.Button(self.menu, text="Старочерниговская", width=18, command=self.select_starochernigovskaya)
        self.btn_list_mkn16.grid(row=19, column=0, padx=20)
        self.btn_list_mkn17 = ttk.Button(self.menu, text="Телегина", width=18, command=self.select_telegina)
        self.btn_list_mkn17.grid(row=20, column=0, padx=20)
        self.btn_list_mkn19 = ttk.Button(self.menu, text="Новополесская", width=18, command=self.select_novopolesskaya)
        self.btn_list_mkn19.grid(row=21, column=0, padx=20)
        self.start()
    ...
    def res_ascue_keys_ind(self, res):
    ...
    def select_gazprom_man(self, res):
        for widget in self.frame_2.winfo_children():
            widget.destroy()
        scrollbar = tk.Scrollbar(self.frame_2)
        scrollbar.pack(side=tk.RIGHT, fill=tk.Y)
    ...
    #блок выборки по кластерам
    def select_mkn_16(self):
        claster = "МКН16"
        self.select_all_claster(claster)
    def select_mkn_17(self):
        claster = "МКН17"
        self.select_all_claster(claster)
    def select_mkn_19(self):
        claster = "МКН19"
        self.select_all_claster(claster)
    def select_aerodrom(self):
        claster = "Аэродром"
        self.select_all_claster(claster)
    def select_all_claster(self, claster):
    ...
    #блок выборки по улицам
    def select_golovackogo(self):
        street = "Головацкого"
        self.result_street(street)
    def select_borodina(self):
        street = "Бородина"
        self.result_street(street)
    def select_mazurova(self):
        street = "Мазурова"
        self.result_street(street)
    def select_kozhara(self):
        street = "Кожара"
        self.result_street(street)
    def select_hataevicha(self):
        street = "Хатаевича"
        self.result_street(street)
    def select_starochernigovskaya(self):
        street = "Старочерниговская"
        self.result_street(street)
    def select_telegina(self):
        street = "Телегина"
        self.result_street(street)
    def select_novopolesskaya(self):
        street = "Новополесская"
        self.result_street(street)
    def result_street(self, street):
