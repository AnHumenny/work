...
class GalleryView(ListView):
    model = Image
    template_name = 'index.html'  # Название Вашего шаблона
    context_object_name = 'images'


def start_filebrowser(request):
    images = Image.objects.order_by("-uploaded_at")[:100]  # 100 последних записей
    return render(request, 'filewiever/index.html', {"images": images})
